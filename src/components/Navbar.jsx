...
const cartNumber = useContext(CartContext)
  ...
  return (
    <div className='flex justify-center items-center sm:w-screen text-white border-b-neutral-500 pb-3 border-b-2 sm:justify-between'>
        ...
        <ul className={`flex gap-4 items-center mr-7 ml-auto sm:flex-col sm:h-full  sm:w-screen sm:gap-12  ${active ? 'sm:-translate-x-full sm:z-auto' : 'translate-x-0'} navbar sm:transition-transform  sm:items-center sm:top-0 sm:left-0 sm:text-white sm:bg-black  sm:fixed sm:justify-center `}>
